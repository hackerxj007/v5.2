...
<div class="content">
	...
	<?php
 global $list,$type_id,$main_classify_id; $type_id = pg('type_id'); $export_content_id=pg('export_content_id'); $classify_id = pg('classify_id'); $table_name = M('classify_type')->where(array('type_id' => $type_id))->getField('table_name'); $classify = M('classify')->where(array('classify_id' => $classify_id))->find(); ?>
