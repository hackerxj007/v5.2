...
<div class="g00002">
  ...
  <div class="g00004" id="right">    
          ...
          <div class="f14729874926">
            ...
            <div class="f14729874928" id="imageMenu">
              <ul class="f14729874929">
                ...
                <?php for($i=1;$i<10;$i++){ if($goods['additional_img'.$i]!=''){ ?>
	...
	<?php
 $goods['price_array']=unserialize($goods['price_array']); foreach($goods['price_array'] as $k=>$v){ $val=$v; unset($val['price']); unset($val['inventory']); unset($val['coding']); unset($val['volume']); unset($val['weight']); $val=implode(',',$val); ?>
          <label>
